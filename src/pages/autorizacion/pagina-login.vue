<template>
  <q-layout view="hHh lpR fFf">
        ...
        <q-toolbar-title class="text-center">
          <div class="row">
            <div class="col-12">
              ...
              >
                <b
                  >SISTEMA DE GESTIÓN DEL INFORME FINAL DE CUMPLIMIENTO DEL TRABAJO
                  ACADÉMICO</b
                >
              </div>
            </div>
    ...
    <div
      class="full-width row justify-center items-center bg-grey-3"
      style="height: 95vh"
    >
      ...
      <q-toolbar>
        <q-toolbar-title>
          <div class="col-12 text-center">
            <div class="text-caption" style="max-width: 100%; white-space: break-spaces">
              <b> UNIVERSIDAD NACIONAL DE LOJA - CARRERA DE COMPUTACIÓN</b>
            </div>
          </div>
        </q-toolbar-title>
      </q-toolbar>
