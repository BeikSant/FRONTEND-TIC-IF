  ...
  <q-card class="q-ma-md" square flat bordered>
    ...
    <q-card-section class="no-padding">
      <q-table
        ...
        virtual-scroll
        :filter="filter"
        :no-data-label="'No posee un historial de informes'"
        :key="'tablePeriodo'"
      ...
      >
        <template v-slot:top>
          <div class="row justify-between items-center full-width">
            <span class="text-subtitle1 text-bold text-uppercase"
              >Lista de Informes por Periodo</span
            >
        ...
        <template v-slot:body-cell-acciones="props">
          <q-td :props="props" auto-width>
            <template
              v-if="
                props.row.firma_director != null &&
                props.row.estadoInforme.estado != 'Novedad documento' &&
                userStore.user.usuario.rol.nombre.toLowerCase() != 'director'
              "
            >
                ...
                >
                  <q-item
                    ...
                    @click="
                      enviarNotificacion(
                        props.row,
                        'indica que el documento del informe final no es correcto'
                      )
                    "
                  >
                    <q-item-section>
                  ...
                  <q-item
                    ...
                    @click="
                      enviarNotificacion(
                        props.row,
                        'indica que la firma del informe final no es válida'
                      )
                    "
                  >
                    <q-item-section>
                  ...
                  <q-item
                    ...
                    @click="
                      enviarNotificacion(
                        props.row,
                        'indica que el informe final enviado no contiene la firma del director'
                      )
                    "
                  >
                    <q-item-section>
              ...
              <q-btn round flat color="grey" size="xs" icon="mdi-help-circle-outline">
                <q-tooltip max-width="150px" style="text-align: center">
                  <span
                    >Notificar al director sobre problemas encontrados en el documento que
                    ha enviado</span
                  >
                </q-tooltip>
              </q-btn>
            ...
            <template v-else>
              ...
              <q-btn round flat color="grey" size="xs" icon="mdi-help-circle-outline">
                ...
                <q-tooltip v-else max-width="100px" style="text-align: center"
                  >Este periodo ya ha culminado</q-tooltip
                >
              </q-btn>
            </template>
          </q-td>
        ...
        <template v-slot:body-cell-firma_docente="props">
          <q-td :props="props" auto-width>
            <template v-if="props.row.firma_docente == null">
              ...
              <q-btn round flat color="grey" size="xs" icon="mdi-help-circle-outline">
                <q-tooltip max-width="150px" style="text-align: center"
                  >Aún no ha enviado el informe</q-tooltip
                >
              </q-btn>
            </template>
          ...
          <q-td :props="props" auto-width>
            ...
            <template v-else>
              <q-btn
                ...
                dense
                @click="
                  desacargarPDF(props.row, props.row.firma_director, 'firma_director')
                "
              >
                <q-tooltip max-width="150px" style="text-align: center"
                  >Descargar Informe</q-tooltip
                    ...
                    <q-item-label v-else-if="col.name == 'firma_director'">
                      ...
                      <template v-else>
                        <q-btn
                          ...
                          dense
                          @click="
                            desacargarPDF(props.row, props.row.firma_director, col.name)
                          "
                        >
                          <q-tooltip max-width="150px" style="text-align: center"
                            >Descargar Informe</q-tooltip
                    ...
                    <q-item-label v-else-if="col.name == 'acciones'">
                      ...
                      >
                        ...
                        >
                          <q-tooltip max-width="150px" style="text-align: center">
                            <span
                              >Notificar al director sobre problemas encontrados en el
                              documento que ha enviado</span
                            >
                          </q-tooltip>
                        </q-btn>
                      </template>
          ...
          <q-card-section>
            <div class="row items-center">
              ...
              <div class="col-9 col-sm-10 q-pt-xs text-justify">
                <span
                  >Se ha enviado la notificación al Director con éxito, espere para
...
const header = [
  ...
  {
    name: "firma_docente",
    label: "INF. FIRMA DOCENTE",
    field: "firma_docente",
    align: "center",
  },
  {
    name: "firma_director",
    label: "INF. FIRMA DIRECTOR",
